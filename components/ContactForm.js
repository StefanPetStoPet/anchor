  ...
  {toast.message}
      ...
      <form onSubmit={handleSubmit(onSubmit, onError)} className="w-full max-w-sm sm:max-w-md md:max-w-lg bg-transparent dark:bg-[#2a3448] backdrop-blur-xl p-8 rounded-2xl shadow-lg">
        ...
        <input
          ...
          className="w-full p-3 mb-6 rounded-lg bg-white dark:bg-[#1e293b] bg-opacity-70 placeholder-black dark:placeholder-white text-black dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-300"
        ...
        <button
          type="submit"
          className="w-full py-3 rounded-lg bg-pastelBlue text-white font-semibold hover:bg-gray-700 transition-colors"
        >
          Send
        </button>
      </form>
